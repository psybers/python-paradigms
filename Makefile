...
package:
	-$(ZIP) replication-pkg.zip $(ZIPOPTIONS) *.py LICENSE.txt Makefile README.md requirements.txt tables/ figures/ boa/ data/*.py data/judgements.csv data/*.xlsx $(ZIPIGNORES)
